 ...
 */
public class mergeJSON extends UDAF {

    // public static Logger log = Logger.getLogger(mergeJSON3.class);

    public static class jsonStr{
        private String str;
    }

    public static class mergeJSONEvaluator implements UDAFEvaluator {

        jsonStr json;

        public mergeJSONEvaluator(){
            super();
            json = new jsonStr();
            init();
            // log.info("################# init #################");
